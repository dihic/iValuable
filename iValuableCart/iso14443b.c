...
void iso14443bSlotMarkerCommand(uint8_t number);
...
//===============================================================
// NAME: void Iso14443bAnticollision(uint8_t command, uint8_t slots)
//
// BRIEF: Is used to perform ISO14443B anticollision sequence.
//
// INPUTS:
//	Parameters:
//		uint8_t		command		REQB or WUPB
//		uint8_t		slots		number of slots
//	
// OUTPUTS:
//
...
void
iso14443bAnticollision(uint8_t command, uint8_t slots)
{
	uint8_t	i = 0, collision = 0x00, j, found = 0;
	uint32_t	k = 0;
	#ifdef ENABLE_HOST
		//uint8_t rssi[2];
	#endif
...
//===============================================================
// NAME: void Iso14443bSlotMarkerCommand(uint8_t number)
//
// BRIEF: Is used to execute ISO14443B Slot-Marker command.
//
// INPUTS:
//	Parameters:
//		uint8_t	number		number of slots
//	
// OUTPUTS:
//
...
void
iso14443bSlotMarkerCommand(uint8_t number)
{
