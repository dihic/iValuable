...
Iso14443aFindTag(void)
{
	...
	Iso14443aAnticollision(0x01);						// do a complete anticollision sequence as described
...
//===============================================================
// NAME: void Iso14443aLoop(uint8_t select, uint8_t nvb, uint8_t
// 			*uid)
//
...
// INPUTS:
//	Parameters:
//		uint8_t		select		indicates cascade level
//		uint8_t		nvb			number of valid bits
//		uint8_t		*uid		known part of UID
//	
// OUTPUTS:
//	Globals:
//		uint8_t		complete_uid[14]	stores UID
//
// PROCESS:	(ISO14443-3)
//
...
void
Iso14443aLoop(uint8_t select, uint8_t nvb, uint8_t *uid)
{
	uint8_t	i = 0, length = 0, new_uid[4], more = 0;
	uint8_t	nvbytes = 0, nvbits = 0, xbits = 0, found = 0;
	#ifdef ENABLE_HOST
		uint8_t rssi[2];
	#endif
...
//===============================================================
// NAME: void Iso14443aAnticollision(uint8_t reqa)
//
// BRIEF: Is used to start the ISO14443A Anticollision Loop.
//
// INPUTS:
//	Parameters:
//		uint8_t		reqa		REQA or WUPA
//	
// OUTPUTS:
//
...
void
Iso14443aAnticollision(uint8_t reqa)
{
	uint8_t	i = 0, select = 0x93, nvb = 0x20;
...
//===============================================================
// NAME: void Iso14443aSelectCommand(uint8_t select, uint8_t *uid)
//
// BRIEF: Is used to execute the ISO14442A select commands.
//
// INPUTS:
//	Parameters:
//		uint8_t		select	selected cascade level
//		uint8_t		*uid		selected uid
//	
// OUTPUTS:
//	Return:
...
uint8_t
Iso14443aSelectCommand(uint8_t select, uint8_t *uid)
{
	uint8_t	j = 0;
